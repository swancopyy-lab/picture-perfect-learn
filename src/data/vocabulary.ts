...
export const vocabulary: VocabWord[] = [
  ...
  // ============================================================
  { id: "u9-airline", word: "airline", type: "noun", meaningEn: "A company that flies passengers", meaningAr: "شركة طيران", example: "Which airline are you flying with?", image: us("PMdBTLJl1Vc"), category: "9 - All Kinds of People" },
  { id: "u9-attraction", word: "attraction", type: "noun", meaningEn: "A place people visit for fun", meaningAr: "معلم سياحي / جذب", example: "The museum is a popular attraction.", image: us("Q3nHyDHeoFo"), category: "9 - All Kinds of People" },
  { id: "u9-editor", word: "editor", type: "noun", meaningEn: "A person who edits text or media", meaningAr: "محرّر", example: "The editor checked the article.", image: us("8hb1u965qhY"), category: "9 - All Kinds of People" },
  { id: "u9-event", word: "event", type: "noun", meaningEn: "A planned occasion or activity", meaningAr: "مناسبة / حدث", example: "The wedding was a beautiful event.", image: us("qr1lLS88iGo"), category: "9 - All Kinds of People" },
  { id: "u9-fake", word: "fake", type: "adjective", meaningEn: "Not real or genuine", meaningAr: "مزيّف", example: "This watch is fake.", image: us("WXpYF0uxW1Y"), category: "9 - All Kinds of People" },
  { id: "u9-flyers", word: "flyers", type: "noun", meaningEn: "Small printed advertisements", meaningAr: "منشورات إعلانية", example: "He handed out flyers in the street.", image: us("Ue7ttHJXf2o"), category: "9 - All Kinds of People" },
  ...
  { id: "u9-thief", word: "thief", type: "noun", meaningEn: "A person who steals", meaningAr: "لص / سارق", example: "The thief ran away with the bag.", image: us("1M__73Gq2BU"), category: "9 - All Kinds of People" },
  { id: "u9-compliment", word: "compliment", type: "verb", meaningEn: "To say something nice about someone", meaningAr: "يُجامل / يُثني على", example: "She complimented my new dress.", image: us("c-LAf90_rYM"), category: "9 - All Kinds of People" },
  { id: "u9-grab", word: "grab", type: "verb", meaningEn: "To take quickly with your hand", meaningAr: "يخطف / يمسك بسرعة", example: "He grabbed his bag and ran.", image: us("NVDNuZlnABY"), category: "9 - All Kinds of People" },
  { id: "u9-recognize", word: "recognize", type: "verb", meaningEn: "To know someone or something you've seen before", meaningAr: "يتعرّف على", example: "I didn't recognize you with your new haircut.", image: us("LPylXWfMpgE"), category: "9 - All Kinds of People" },
  { id: "u9-spill", word: "spill", type: "verb", meaningEn: "To accidentally pour out a liquid", meaningAr: "يسكب / يُريق", example: "Don't spill the milk!", image: us("BL_f4gQ0TXI"), category: "9 - All Kinds of People" },
  { id: "u9-steal", word: "steal", type: "verb", meaningEn: "To take something that isn't yours", meaningAr: "يسرق", example: "Someone tried to steal my phone.", image: us("6oUzGsvwJAE"), category: "9 - All Kinds of People" },
  { id: "u9-absentminded", word: "absentminded", type: "adjective", meaningEn: "Forgetful; not paying attention", meaningAr: "شارد الذهن", example: "My grandpa is a bit absentminded.", image: us("0G2ZxV31kk4"), category: "9 - All Kinds of People" },
  { id: "u9-athletic", word: "athletic", type: "adjective", meaningEn: "Good at sports; physically strong", meaningAr: "رياضي البنية", example: "She's very athletic and runs every day.", image: us("kp0ygaEf5oU"), category: "9 - All Kinds of People" },
  { id: "u9-clever", word: "clever", type: "adjective", meaningEn: "Quick to learn; smart", meaningAr: "ذكي / فطن", example: "What a clever idea!", image: us("akocAO9QCHM"), category: "9 - All Kinds of People" },
  { id: "u9-efficient", word: "efficient", type: "adjective", meaningEn: "Working well without waste", meaningAr: "فعّال / كفؤ", example: "She's a very efficient worker.", image: us("-cbZ5SD8d5I"), category: "9 - All Kinds of People" },
  { id: "u9-generous", word: "generous", type: "adjective", meaningEn: "Willing to give freely", meaningAr: "كريم / سخي", example: "He's generous with his money.", image: us("BwEaiY0xJPk"), category: "9 - All Kinds of People" },
  { id: "u9-hardworking", word: "hardworking", type: "adjective", meaningEn: "Working with great effort", meaningAr: "مجتهد", example: "She's a hardworking student.", image: us("QiLPQeQSXD0"), category: "9 - All Kinds of People" },
  { id: "u9-honest", word: "honest", type: "adjective", meaningEn: "Truthful and trustworthy", meaningAr: "صادق", example: "I appreciate your honest answer.", image: us("isL10VqrJ1g"), category: "9 - All Kinds of People" },
  { id: "u9-kind", word: "kind", type: "adjective", meaningEn: "Caring and helpful to others", meaningAr: "لطيف / طيّب", example: "She's so kind to everyone.", image: us("6C_XfszlnWw"), category: "9 - All Kinds of People" },
  { id: "u9-lazy", word: "lazy", type: "adjective", meaningEn: "Not wanting to work or be active", meaningAr: "كسول", example: "Don't be lazy! Get up and help.", image: us("_wdfTR14N_4"), category: "9 - All Kinds of People" },
  { id: "u9-optimistic", word: "optimistic", type: "adjective", meaningEn: "Expecting good things to happen", meaningAr: "متفائل", example: "She's optimistic about the future.", image: us("26rK1-bH9Ls"), category: "9 - All Kinds of People" },
  { id: "u9-patient", word: "patient", type: "adjective", meaningEn: "Able to wait calmly", meaningAr: "صبور", example: "Be patient; the train is coming.", image: us("uiIEWSXbQCM"), category: "9 - All Kinds of People" },
  { id: "u9-persuasive", word: "persuasive", type: "adjective", meaningEn: "Able to convince others", meaningAr: "مُقنع", example: "He's a very persuasive speaker.", image: us("2aXDbXcNySg"), category: "9 - All Kinds of People" },
  { id: "u9-pessimistic", word: "pessimistic", type: "adjective", meaningEn: "Expecting bad things to happen", meaningAr: "متشائم", example: "Don't be so pessimistic about the trip.", image: us("ulPAVuxITEw"), category: "9 - All Kinds of People" },
  { id: "u9-polite", word: "polite", type: "adjective", meaningEn: "Showing good manners", meaningAr: "مؤدب", example: "Always be polite to others.", image: us("QprW-MA7Er0"), category: "9 - All Kinds of People" },
  ...
  { id: "u9-hand-out", word: "hand out", type: "expression", meaningEn: "To give to many people", meaningAr: "يوزّع", example: "He handed out flyers downtown.", image: us("Ue7ttHJXf2o"), category: "9 - All Kinds of People" },
