...
export const vocabulary: VocabWord[] = [
  ...
  // ============================================================
  { id: "u9-airline", word: "airline", type: "noun", meaningEn: "A company that flies passengers", meaningAr: "شركة طيران", example: "Which airline are you flying with?", image: img("photo-1436491865332-7a61a109cc05"), category: "9 - All Kinds of People" },
  { id: "u9-attraction", word: "attraction", type: "noun", meaningEn: "A place people visit for fun", meaningAr: "معلم سياحي / جذب", example: "The museum is a popular attraction.", image: img("photo-1502602898657-3e91760cbb34"), category: "9 - All Kinds of People" },
  { id: "u9-editor", word: "editor", type: "noun", meaningEn: "A person who edits text or media", meaningAr: "محرّر", example: "The editor checked the article.", image: img("photo-1486312338219-ce68d2c6f44d"), category: "9 - All Kinds of People" },
  { id: "u9-event", word: "event", type: "noun", meaningEn: "A planned occasion or activity", meaningAr: "مناسبة / حدث", example: "The wedding was a beautiful event.", image: img("photo-1492684223066-81342ee5ff30"), category: "9 - All Kinds of People" },
  { id: "u9-fake", word: "fake", type: "adjective", meaningEn: "Not real or genuine", meaningAr: "مزيّف", example: "This watch is fake.", image: img("photo-1523275335684-37898b6baf30"), category: "9 - All Kinds of People" },
  { id: "u9-flyers", word: "flyers", type: "noun", meaningEn: "Small printed advertisements", meaningAr: "منشورات إعلانية", example: "He handed out flyers in the street.", image: img("photo-1586953208448-b95a79798f07"), category: "9 - All Kinds of People" },
  { id: "u9-pedal-cab", word: "pedal cab", type: "noun", meaningEn: "A small taxi powered by pedaling", meaningAr: "عربة تاكسي بدوّاسات", example: "We took a pedal cab through the park.", image: img("photo-1519501025264-65ba15a82390"), category: "9 - All Kinds of People" },
  { id: "u9-thief", word: "thief", type: "noun", meaningEn: "A person who steals", meaningAr: "لص / سارق", example: "The thief ran away with the bag.", image: img("photo-1509822929063-6b6cfc9b42f2"), category: "9 - All Kinds of People" },
  { id: "u9-compliment", word: "compliment", type: "verb", meaningEn: "To say something nice about someone", meaningAr: "يُجامل / يُثني على", example: "She complimented my new dress.", image: img("photo-1521791136064-7986c2920216"), category: "9 - All Kinds of People" },
  { id: "u9-grab", word: "grab", type: "verb", meaningEn: "To take quickly with your hand", meaningAr: "يخطف / يمسك بسرعة", example: "He grabbed his bag and ran.", image: img("photo-1505663912202-ac22d4cb3707"), category: "9 - All Kinds of People" },
  { id: "u9-recognize", word: "recognize", type: "verb", meaningEn: "To know someone or something you've seen before", meaningAr: "يتعرّف على", example: "I didn't recognize you with your new haircut.", image: img("photo-1485217988980-11786ced9454"), category: "9 - All Kinds of People" },
  { id: "u9-spill", word: "spill", type: "verb", meaningEn: "To accidentally pour out a liquid", meaningAr: "يسكب / يُريق", example: "Don't spill the milk!", image: img("photo-1517232115160-ff93364542dd"), category: "9 - All Kinds of People" },
  { id: "u9-steal", word: "steal", type: "verb", meaningEn: "To take something that isn't yours", meaningAr: "يسرق", example: "Someone tried to steal my phone.", image: img("photo-1509822929063-6b6cfc9b42f2"), category: "9 - All Kinds of People" },
  { id: "u9-absentminded", word: "absentminded", type: "adjective", meaningEn: "Forgetful; not paying attention", meaningAr: "شارد الذهن", example: "My grandpa is a bit absentminded.", image: img("photo-1507003211169-0a1dd7228f2d"), category: "9 - All Kinds of People" },
  { id: "u9-athletic", word: "athletic", type: "adjective", meaningEn: "Good at sports; physically strong", meaningAr: "رياضي البنية", example: "She's very athletic and runs every day.", image: img("photo-1517836357463-d25dfeac3438"), category: "9 - All Kinds of People" },
  { id: "u9-clever", word: "clever", type: "adjective", meaningEn: "Quick to learn; smart", meaningAr: "ذكي / فطن", example: "What a clever idea!", image: img("photo-1488998427799-e3362cec87c3"), category: "9 - All Kinds of People" },
  { id: "u9-efficient", word: "efficient", type: "adjective", meaningEn: "Working well without waste", meaningAr: "فعّال / كفؤ", example: "She's a very efficient worker.", image: img("photo-1521737711867-e3b97375f902"), category: "9 - All Kinds of People" },
  { id: "u9-generous", word: "generous", type: "adjective", meaningEn: "Willing to give freely", meaningAr: "كريم / سخي", example: "He's generous with his money.", image: img("photo-1488521787991-ed7bbaae773c"), category: "9 - All Kinds of People" },
  { id: "u9-hardworking", word: "hardworking", type: "adjective", meaningEn: "Working with great effort", meaningAr: "مجتهد", example: "She's a hardworking student.", image: img("photo-1454165804606-c3d57bc86b40"), category: "9 - All Kinds of People" },
  { id: "u9-honest", word: "honest", type: "adjective", meaningEn: "Truthful and trustworthy", meaningAr: "صادق", example: "I appreciate your honest answer.", image: img("photo-1521791055366-0d553872125f"), category: "9 - All Kinds of People" },
  { id: "u9-kind", word: "kind", type: "adjective", meaningEn: "Caring and helpful to others", meaningAr: "لطيف / طيّب", example: "She's so kind to everyone.", image: img("photo-1517245386807-bb43f82c33c4"), category: "9 - All Kinds of People" },
  { id: "u9-lazy", word: "lazy", type: "adjective", meaningEn: "Not wanting to work or be active", meaningAr: "كسول", example: "Don't be lazy! Get up and help.", image: img("photo-1499728603263-13726abce5fd"), category: "9 - All Kinds of People" },
  { id: "u9-optimistic", word: "optimistic", type: "adjective", meaningEn: "Expecting good things to happen", meaningAr: "متفائل", example: "She's optimistic about the future.", image: img("photo-1531746020798-e6953c6e8e04"), category: "9 - All Kinds of People" },
  { id: "u9-patient", word: "patient", type: "adjective", meaningEn: "Able to wait calmly", meaningAr: "صبور", example: "Be patient; the train is coming.", image: img("photo-1493836512294-502baa1986e2"), category: "9 - All Kinds of People" },
  { id: "u9-persuasive", word: "persuasive", type: "adjective", meaningEn: "Able to convince others", meaningAr: "مُقنع", example: "He's a very persuasive speaker.", image: img("photo-1573497019940-1c28c88b4f3e"), category: "9 - All Kinds of People" },
  { id: "u9-pessimistic", word: "pessimistic", type: "adjective", meaningEn: "Expecting bad things to happen", meaningAr: "متشائم", example: "Don't be so pessimistic about the trip.", image: img("photo-1499728603263-13726abce5fd"), category: "9 - All Kinds of People" },
  { id: "u9-polite", word: "polite", type: "adjective", meaningEn: "Showing good manners", meaningAr: "مؤدب", example: "Always be polite to others.", image: img("photo-1521791136064-7986c2920216"), category: "9 - All Kinds of People" },
  { id: "u9-quiet", word: "quiet", type: "adjective", meaningEn: "Not making much noise", meaningAr: "هادئ", example: "Please be quiet in the library.", image: img("photo-1471201306405-0426bcce27a8"), category: "9 - All Kinds of People" },
  { id: "u9-reliable", word: "reliable", type: "adjective", meaningEn: "Can be trusted; dependable", meaningAr: "موثوق", example: "He's a reliable friend.", image: img("photo-1521791055366-0d553872125f"), category: "9 - All Kinds of People" },
  { id: "u9-rude", word: "rude", type: "adjective", meaningEn: "Showing bad manners", meaningAr: "وقح / فظ", example: "It's rude to interrupt people.", image: img("photo-1504593811423-6dd665756598"), category: "9 - All Kinds of People" },
  ...
  { id: "u9-hand-out", word: "hand out", type: "expression", meaningEn: "To give to many people", meaningAr: "يوزّع", example: "He handed out flyers downtown.", image: img("photo-1586953208448-b95a79798f07"), category: "9 - All Kinds of People" },
  ...
  // ============================================================
  { id: "u11-airshow", word: "airshow", type: "noun", meaningEn: "A public display of flying aircraft", meaningAr: "عرض طيران", example: "The airshow was amazing to watch.", image: img("photo-1436491865332-7a61a109cc05"), category: "11 - Making Choices" },
  ...
  { id: "u11-conservationist", word: "conservationist", type: "noun", meaningEn: "Someone who protects nature", meaningAr: "مدافع عن البيئة", example: "She's a famous conservationist.", image: img("photo-1500382017468-9049fed747ef"), category: "11 - Making Choices" },
  ...
  { id: "u11-farmer", word: "farmer", type: "noun", meaningEn: "Someone who works on a farm", meaningAr: "مزارع", example: "The farmer grows vegetables.", image: img("photo-1500595046743-cd271d694d30"), category: "11 - Making Choices" },
  { id: "u11-graduation", word: "graduation", type: "noun", meaningEn: "Ceremony of completing studies", meaningAr: "حفل التخرّج", example: "Her graduation is next week.", image: img("photo-1523050854058-8df90110c9f1"), category: "11 - Making Choices" },
  { id: "u11-pollution", word: "pollution", type: "noun", meaningEn: "Harmful substances in the environment", meaningAr: "تلوّث", example: "Air pollution is a big problem.", image: img("photo-1611273426858-450d8e3c9fce"), category: "11 - Making Choices" },
  ...
  { id: "u11-resort", word: "resort", type: "noun", meaningEn: "A place for vacations and relaxation", meaningAr: "منتجع", example: "We stayed at a beach resort.", image: img("photo-1507525428034-b723cf961d3e"), category: "11 - Making Choices" },
  { id: "u11-route", word: "route", type: "noun", meaningEn: "The way from one place to another", meaningAr: "طريق / مسار", example: "Take the shortest route home.", image: img("photo-1502920917128-1aa500764cbd"), category: "11 - Making Choices" },
  ...
  { id: "u11-subject", word: "subject", type: "noun", meaningEn: "A topic of study", meaningAr: "مادة دراسية / موضوع", example: "Math is my favorite subject.", image: img("photo-1497633762265-9d179a990aa6"), category: "11 - Making Choices" },
  { id: "u11-care", word: "care", type: "verb", meaningEn: "To feel concern or interest", meaningAr: "يهتم", example: "I care about my family.", image: img("photo-1488521787991-ed7bbaae773c"), category: "11 - Making Choices" },
  ...
  { id: "u11-fit-in", word: "fit in", type: "verb", meaningEn: "To feel accepted in a group", meaningAr: "ينسجم / يندمج", example: "She fits in well at her new school.", image: img("photo-1529156069898-49953e39b3ac"), category: "11 - Making Choices" },
  ...
  { id: "u11-graduate", word: "graduate", type: "verb", meaningEn: "To complete studies and earn a degree", meaningAr: "يتخرّج", example: "She'll graduate next June.", image: img("photo-1523050854058-8df90110c9f1"), category: "11 - Making Choices" },
  ...
  { id: "u11-study", word: "study", type: "verb", meaningEn: "To learn about a subject", meaningAr: "يدرس", example: "She studies every night.", image: img("photo-1497633762265-9d179a990aa6"), category: "11 - Making Choices" },
  { id: "u11-scenic", word: "scenic", type: "adjective", meaningEn: "Having beautiful natural views", meaningAr: "ذو مناظر خلّابة", example: "We took the scenic route home.", image: img("photo-1469854523086-cc02fe5d8800"), category: "11 - Making Choices" },
