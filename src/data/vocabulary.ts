...
// Unit 10 additions
import alreadyImg from "@/assets/unit10/already.png";
import justImg from "@/assets/unit10/just.png";
...
import scholarshipImg from "@/assets/unit11/scholarship.png";
import beAgainstImg from "@/assets/unit11/be-against.png";
import feelLikeImg from "@/assets/unit11/feel-like.png";
import fitInNewImg from "@/assets/unit11/fit-in-new.png";
import fitInSuitImg from "@/assets/unit11/fit-in-suit.png";
import passTestImg from "@/assets/unit11/pass-test.png";
import wouldRatherImg from "@/assets/unit11/would-rather.png";
import makeUpMindImg from "@/assets/unit11/make-up-mind.png";
import seemsToMeImg from "@/assets/unit11/seems-to-me.png";
import upInTheAirImg from "@/assets/unit11/up-in-the-air.png";
// Unit 12
import u12BreakImg from "@/assets/unit12/break.jpg";
import u12CustomImg from "@/assets/unit12/custom.jpg";
import u12DustImg from "@/assets/unit12/dust.jpg";
import u12GraduateImg from "@/assets/unit12/graduate.jpg";
import u12MudImg from "@/assets/unit12/mud.jpg";
import u12PocketImg from "@/assets/unit12/pocket.jpg";
import u12ShockImg from "@/assets/unit12/shock.jpg";
import u12TipVerbImg from "@/assets/unit12/tip-verb.jpg";
import u12AllowImg from "@/assets/unit12/allow.jpg";
import u12CommentImg from "@/assets/unit12/comment.jpg";
import u12RestImg from "@/assets/unit12/rest.jpg";
import u12SpearImg from "@/assets/unit12/spear.jpg";
import u12BlockImg from "@/assets/unit12/block.png";
import u12CrowdedImg from "@/assets/unit12/crowded.png";
import u12ExchangeImg from "@/assets/unit12/exchange.png";
import u12ExpectImg from "@/assets/unit12/expect.png";
import u12GuestImg from "@/assets/unit12/guest.png";
import u12HandleImg from "@/assets/unit12/handle.png";
import u12ImpressionImg from "@/assets/unit12/impression.png";
import u12InterfereImg from "@/assets/unit12/interfere.png";
import u12InvolveImg from "@/assets/unit12/involve.png";
import u12ManageImg from "@/assets/unit12/manage.png";
import u12PorterImg from "@/assets/unit12/porter.png";
import u12RemoveImg from "@/assets/unit12/remove.png";
import u12SpreadImg from "@/assets/unit12/spread.png";
...
import u12CustomaryImg from "@/assets/unit12/customary.png";
import u12LocalImg from "@/assets/unit12/local.png";
import u12PunctualImg from "@/assets/unit12/punctual.png";
import u12RelaxedImg from "@/assets/unit12/relaxed.jpg";
import u12SimilarImg from "@/assets/unit12/similar.png";
...
export const vocabulary: VocabWord[] = [
  ...
  { id: "u11-fail", word: "fail", type: "verb", meaningEn: "To not succeed", meaningAr: "يفشل / يرسب", example: "Don't be afraid to fail.", image: failImg, category: "11 - Making Choices" },
  { id: "u11-fit-in", word: "fit in", type: "verb", meaningEn: "To feel accepted in a group", meaningAr: "ينسجم / يندمج", example: "She fits in well at her new school.", image: fitInNewImg, category: "11 - Making Choices" },
  ...
  { id: "u11-interfere", word: "interfere", type: "verb", meaningEn: "To get involved without being asked", meaningAr: "يتدخّل", example: "Don't interfere in their argument.", image: u12InterfereImg, category: "11 - Making Choices" },
  { id: "u11-involve", word: "involve", type: "verb", meaningEn: "To include as a necessary part", meaningAr: "يتضمّن / يشمل", example: "The job involves a lot of travel.", image: u12InvolveImg, category: "11 - Making Choices" },
  { id: "u11-pass-test", word: "pass (a test)", type: "verb", meaningEn: "To succeed in a test", meaningAr: "ينجح في اختبار", example: "I hope to pass the math test.", image: passTestImg, category: "11 - Making Choices" },
  ...
  { id: "u11-fit-in-suit", word: "fit (someone)", type: "verb", meaningEn: "To look good on a person; to suit them", meaningAr: "يليق على الشخص", example: "That dress really fits her.", image: fitInSuitImg, category: "11 - Making Choices" },
  ...
  { id: "u11-up-in-the-air", word: "up in the air", type: "expression", meaningEn: "Not yet decided", meaningAr: "غير محسوم بعد", example: "Our travel plans are still up in the air.", image: upInTheAirImg, category: "11 - Making Choices" },

  // ============================================================
  // UNIT 12 — Culture Shock
  // ============================================================
  { id: "u12-break", word: "break", type: "noun", meaningEn: "A short rest or pause", meaningAr: "استراحة", example: "Let's take a short break.", image: u12BreakImg, category: "12 - Culture Shock" },
  ...
  { id: "u12-custom", word: "custom", type: "noun", meaningEn: "A traditional way of behaving", meaningAr: "عادة / تقليد", example: "It's a custom to remove your shoes here.", image: u12CustomImg, category: "12 - Culture Shock" },
  ...
  { id: "u12-shock", word: "shock", type: "noun", meaningEn: "A sudden upsetting surprise", meaningAr: "صدمة", example: "The news came as a shock.", image: u12ShockImg, category: "12 - Culture Shock" },
  ...
  { id: "u12-comment", word: "comment", type: "verb", meaningEn: "To express an opinion", meaningAr: "يعلّق", example: "She commented on the new design.", image: u12CommentImg, category: "12 - Culture Shock" },
  { id: "u12-exchange", word: "exchange", type: "verb", meaningEn: "To give one thing and receive another", meaningAr: "يتبادل", example: "We exchanged gifts at Christmas.", image: u12ExchangeImg, category: "12 - Culture Shock" },
  { id: "u12-expect", word: "expect", type: "verb", meaningEn: "To think something will happen", meaningAr: "يتوقّع", example: "I expect to arrive at noon.", image: u12ExpectImg, category: "12 - Culture Shock" },
  { id: "u12-handle", word: "handle", type: "verb", meaningEn: "To deal with a situation", meaningAr: "يتعامل مع", example: "She can handle any problem.", image: u12HandleImg, category: "12 - Culture Shock" },
  ...
  { id: "u12-crowded", word: "crowded", type: "adjective", meaningEn: "Full of people", meaningAr: "مزدحم", example: "The bus was very crowded.", image: u12CrowdedImg, category: "12 - Culture Shock" },
  { id: "u12-customary", word: "customary", type: "adjective", meaningEn: "Usual; following custom", meaningAr: "اعتيادي / متعارف عليه", example: "It's customary to bring a gift.", image: u12CustomaryImg, category: "12 - Culture Shock" },
  ...
  { id: "u12-local", word: "local", type: "adjective", meaningEn: "From a particular nearby area", meaningAr: "محلي", example: "Try the local food.", image: u12LocalImg, category: "12 - Culture Shock" },
  { id: "u12-punctual", word: "punctual", type: "adjective", meaningEn: "On time; not late", meaningAr: "ملتزم بالمواعيد", example: "Please be punctual for the meeting.", image: u12PunctualImg, category: "12 - Culture Shock" },
  { id: "u12-relaxed", word: "relaxed", type: "adjective", meaningEn: "Calm and free from worry", meaningAr: "مسترخٍ / مرتاح", example: "She felt relaxed on the beach.", image: u12RelaxedImg, category: "12 - Culture Shock" },
  { id: "u12-similar", word: "similar", type: "adjective", meaningEn: "Almost the same", meaningAr: "مشابه", example: "These two cars look similar.", image: u12SimilarImg, category: "12 - Culture Shock" },
